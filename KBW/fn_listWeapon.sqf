...
[805, player, format["Listed %1 on the Exchange for $%2 with a fee of $%3.", currentWeapon Player, _price, _fee]] remoteExecCall ["ASY_fnc_logIt",2];
[1,[currentWeapon player,_attach],_price,player] remoteExecCall ["KBW_fnc_listing",2];
