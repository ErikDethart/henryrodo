...
[nil,player,true,_toCheck,getPlayerUID player] remoteExecCall ["KBW_fnc_getOffers",2];
	lbClear 2802;
...
ctrlShow[1901,false];
ctrlShow[1902,true];
[_className,player,true,_toCheck,getPlayerUID player] remoteExecCall ["KBW_fnc_getOffers",2];
