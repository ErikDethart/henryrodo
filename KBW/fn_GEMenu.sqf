...
if(count _offers == 0) then {_control lbAdd "No Offers Found!"};
{
	...
	_control lbSetData [(lbSize _control)-1,str([_displayName,_price,_buySell,_className,_type,_amount,_vehicleID,_offeror,_offerorPID])];
	if(_nonVirt) then {
