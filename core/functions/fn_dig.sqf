...
[player,"AwopPknlMstpSgthWpstDnon_Part5","playNow",0.45] remoteExecCall ["life_fnc_animSync",-2];
[player, "pickaxe",10] remoteExecCall ["life_fnc_playSound",-2];
uiSleep 3;
[player,"","stop",0] remoteExecCall ["life_fnc_animSync",-2];
...
[2002, player, format["Dug up treasure with map %2 worth $%1!",_totalValue, _map]] remoteExecCall ["ASY_fnc_logIt",2];
