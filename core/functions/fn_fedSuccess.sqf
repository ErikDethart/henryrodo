...
//[69, player, format["Bank was robbed and lost %1", life_atmmoney]] remoteExecCall ["ASY_fnc_logIt",2];
...
//[69, player, format["Bank was robbed and lost 0"]] remoteExecCall ["ASY_fnc_logIt",2];
	}
		else
	{
		...
		["atm","take",_funds] call life_fnc_updateMoney;
//[69, player, format["Bank was robbed and lost %1", _funds]] remoteExecCall ["ASY_fnc_logIt",2];
	};
};
