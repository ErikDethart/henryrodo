...
if(_val > 999999) exitWith {hint "You can't transfer more than $999,999";};
...
if(getPlayerUID _unit in life_arrested_uid) exitWith {hint "You have recently arrested this player; as such the bank has declined your transfer!"};
...
["atm","take",(_val + _tax)] call life_fnc_updateMoney;

bank_addfunds = _tax;
publicVariableServer "bank_addfunds";
[_val,[name player] call life_fnc_cleanName] remoteExecCall ["life_fnc_clientWireTransfer",_unit];
[] call life_fnc_atmMenu;
hint format["You have transferred $%1 to %2.\n\nA tax fee of $%3 was taken for the wire transfer.",[_val] call life_fnc_numberText,[name _unit] call life_fnc_cleanName,[_tax] call life_fnc_numberText];
[159, player, format["Transferred $%1 to %2 (%3) with tax fee of $%4", _val, name _unit, getPlayerUID _unit, _tax]] remoteExecCall ["ASY_fnc_logIt",2];
