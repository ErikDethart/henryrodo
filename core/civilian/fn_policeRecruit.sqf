...
_civ = [format["So you'd like to become a police officer, %1?,<br/><br/>
		...
		to this small nation, you're already on your way.<br/><br/>You must be at least 17 years of age and have 12 or more talent points on the Asylum servers as a civilian.  If you meet these
		...
		roles on Asylum servers.  You'll protect the citizens in many ways, while stopping rebels in actions such as bank and federal reserve robberies, prison breaks, and so much more.<br/><br/>
		...
		apply now on our forums at <t color='#4444FF'>www.Gaming-Asylum.com</t>.  Visit the Police Applications forum.", [name player] call life_fnc_cleanName, worldName]];
