...
if (time - (life_last_bounty select 0) < 10) exitWith { hint "You must wait 10 seconds to request another bounty."; };
...
[player,_max,life_bounty_uid,_maxBounties] remoteExecCall ["life_fnc_wantedGetBounty",2];
