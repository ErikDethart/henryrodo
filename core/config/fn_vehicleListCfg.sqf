...

{
	...
	{
		if ((life_donator >= _x select 4) && ((call life_coplevel) >= _x select 5) && (life_swatlevel >= _x select 6) && ((_x select 7) == 0 || (_x select 7) in life_talents) && ((_x select 9) == 0 || (((_x select 9) in life_coptalents) && (life_coprole in ["all","detective"]))) && ((_x select 10) == 0 || (_x select 10) in life_achievements)) then
		{
