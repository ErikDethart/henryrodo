...
_shorttext         = "The longest standing Arma 3 Life RPG community";
_posText        = [0.65,0.5,0.4];

_title2         = "Most Wealthy";
_shorttext2     = "";
...
_title4            = "Teamspeak";
_shorttext4      = "Need support? Join our Teamspeak server! ts3.gaming-asylum.com:9216";
