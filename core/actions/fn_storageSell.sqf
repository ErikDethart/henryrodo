...
if (!(_house in life_ownHouses)) exitWith { hint "You do not own this crate and thus cannot destroy it!"; };
...
[_item, player] remoteExecCall ["ASY_fnc_removeStorage",2];
[451, player, format["Sold storage in house %1", [_house] call life_fnc_getBuildID]] remoteExecCall ["ASY_fnc_logIt",2];
