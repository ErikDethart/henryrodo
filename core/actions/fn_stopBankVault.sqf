...
[player,"Acts_carFixingWheel"] remoteExecCall ["life_fnc_animSync",-2];
while {true} do
{
...
if (_success) then
{
	...
	publicVariable "life_bank_drilling";
	{
		...
		{
[[0,1,2],format["Officer %1 has stopped the vault drill! The robbery has failed.", [profileName] call life_fnc_cleanName]] remoteExecCall ["life_fnc_broadcast",_x];
		};
	} forEach allPlayers;
};
