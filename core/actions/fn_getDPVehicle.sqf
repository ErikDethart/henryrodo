...
//[17, player, format["Started delivery mission to %1", _dp]] remoteExecCall ["ASY_fnc_logIt",2];
...
//[18, player, format["Failed delivery mission due to death"]] remoteExecCall ["ASY_fnc_logIt",2];
