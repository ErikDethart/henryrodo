...
//	Author: Mike "Revir" Berlin (Totally copied Skalicon)
//	Description: Knock outs out the player if they're in a certain distance of another player.
...
//[player,_unit] remoteExecCall ["life_fnc_knockedOut",_unit];
