...
if (player distance (getMarkerPos "corrections") < 200) exitWith { hint "The roots of this plant are too sturdy for you to harvest from it." };
...
[player,"AinvPercMstpSnonWnonDnon_Putdown_AmovPercMstpSnonWnonDnon","switch",0] remoteExecCall ["life_fnc_animSync",-2];
