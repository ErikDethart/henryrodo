...
if(player getVariable ["restrained",false]) exitWith {hint "Turning yourself in is not available while restrained!"};
...
else
{
	...
	{
[getPlayerUID player] remoteExecCall ["life_fnc_wantedPardon",2];
		["atm","take",life_wanted] call life_fnc_updateMoney;
