...
if (life_wanted > 100 && _type == "bounty") exitWith { hint "You cannot acquire a bounty hunting license when you are wanted yourself! Turn yourself in, first." };
...
PlaySound "purchase";
//[3, player, format["Purchased license %1 for %2", _license select 1, _price]] remoteExecCall ["ASY_fnc_logIt",2];
