...
["atm","take",life_bail_amount] call life_fnc_updateMoney;
life_bail_paid = true;
[0,format["%1 has posted bail!", name _unit]] remoteExecCall ["life_fnc_broadcast",-2];
//[35, _unit, format["Posted bail of %1", life_bail_amount]] remoteExecCall ["ASY_fnc_logIt",2];
