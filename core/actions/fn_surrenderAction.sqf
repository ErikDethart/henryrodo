...
if (_unit getVariable["playerSurrender",false]) then {
	...
	detach _unit;
	deleteVehicle _obj;
[_unit,"AmovPercMstpSsurWnonDnon_AmovPercMstpSnonWnonDnon","playNow"] remoteExecCall ["life_fnc_animSync",-2];
[_unit,"AmovPercMstpSsurWnonDnon_AmovPercMstpSnonWnonDnon","switch"] remoteExecCall ["life_fnc_animSync",-2];
