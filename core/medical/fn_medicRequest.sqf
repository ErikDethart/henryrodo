...
//	Description: Notifies the medics that someone has requested emergency and prompts them if they want to take the request or not.
...
["MedicalRequestEmerg",[format["%1 is requesting a paramedic.",[name _caller] call life_fnc_cleanName]]] call BIS_fnc_showNotification;
