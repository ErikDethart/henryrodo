...
{[_x,true,false,false,false] call life_fnc_handleItem;} foreach _items; // Includes headgear/goggles
...
{[_x,true,false,false,false] call life_fnc_handleItem;} foreach _magazines;
