...
//	Description: Doesn't work without the server-side effect but shifted part of it clientside so code can easily be changed. Ultimately it just pops the tires.
...
//[53, player, format["Vehicle %1 hit spike strips", typeOf _vehicle]] remoteExecCall ["ASY_fnc_logIt",2];
