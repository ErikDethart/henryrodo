...
if (!life_summonedSWAT || (player getVariable ["swatlevel",0] < 1 && (call life_coplevel) < 3)) exitWith {hint "You are not currently permitted to join SWAT."};
...
[player] remoteExecCall ["ASY_fnc_swatRegistered",2];
