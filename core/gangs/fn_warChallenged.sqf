...
if (!(_gang in life_gang_challenges)) then
{
	...
	hint parseText format ["<t color='#FF0000'><t size='2'>War Challenge!</t></t><br/><t color='#FFFFFF'>You have received a challenge of war from %1 of <t color='#FF0000'>%2</t>!", [name _unit] call life_fnc_cleanName, _gangName];
};
