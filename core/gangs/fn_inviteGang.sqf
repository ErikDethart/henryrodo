...
if (_send) then
{
	...
	hint format["Sending gang invitation to %1...", [name _info] call life_fnc_cleanName];
	closeDialog 0;
[player,life_gang, player getVariable ["gangName","unknown"]] remoteExecCall ["life_fnc_invitedGang",_info];
}
else
{
