...
[[1,2], format["%1 has sent you an invitation to join the gang, %2. Press 9 within 30 seconds to accept!", [name _unit] call life_fnc_cleanName, [_name] call life_fnc_cleanName]] spawn life_fnc_broadcast;
