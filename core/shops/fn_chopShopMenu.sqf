...
if((player getVariable ["playerSurrender",false]) || (player getVariable ["restrained",false])) exitWith {hint "The chopshop vendor merely looks at you and chuckles heartily."};
