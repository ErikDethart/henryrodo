...
if(getPlayerUID _unit in life_arrested_uid) exitWith {hint "You have recently arrested this player; you cannot give them the money you made from their arrest!"};
...
hint format["You gave $%1 to %2",[(parseNumber(_amount))] call life_fnc_numberText,[name _unit] call life_fnc_cleanName];
["cash","take",parseNumber(_amount)] call life_fnc_updateMoney;
