...
switch (_mode) do
{
	...
	{
		life_volume = _value;
		ctrlSetText[2932,format["%1%2",round(_value * 100),"%"]];
		[] spawn{ 0 fadeSound life_volume };
	};
	case 8:
	{
			call compile format ["%1 = %2",_marker,_value];
			[_color,_value] spawn life_fnc_updateMarkers;
	};
};