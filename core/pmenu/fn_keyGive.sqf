...
_owners set[count _owners,[_uid,[name _unit] call life_fnc_cleanName]];
_vehicle setVariable["vehicle_info_owners",_owners,true];

hint format["You have given %1 keys to your %2",[name _unit] call life_fnc_cleanName,getText(configFile >> "CfgVehicles" >> (typeOf _vehicle) >> "displayName")];
[_vehicle,_unit,name player] remoteExecCall ["life_fnc_clientGetKey",_unit];

//[65, player, format["Gave keys for %1 to %2", typeOf _vehicle, name _unit]] remoteExecCall ["ASY_fnc_logIt",2];
