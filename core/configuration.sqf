...
life_phone_buttons = [
	...
	["Perks", "icons\phone_gang.paa", "life_gangperk = true; createDialog 'life_talent_menu'", "playerSide == civilian && life_gang != ""0""", "View and/or manage your gang perks"],
	["Infamy", "icons\phone_infamy.paa", "createDialog 'life_infamy_menu'", "playerSide == civilian && license_civ_rebel", "View and/or manage your infamy perks"],
	//["Donation", "icons\phone_donate.paa", "createDialog ""life_donation_menu""", "(call life_adminlevel) < 2", "View your donor level and donation rewards"],
	...
	["Prestige", "icons\phone_prestige.paa", "createDialog ""life_prestige_menu"";", "playerSide == west && (call life_coplevel) > 2", "View your prestige specialities and assign points"],
...
life_achievementInfo = [
	// side, title, condition, description, reward description, title, hidden
	[[civilian,west,independent], "Prestigious", {false}, "Earned first prestige points.", "None", ""],
	[[civilian,west,independent], "Upper Class", {false}, "Obtained over 500,000 prestige and Money cap: $1,500,000", "None"],
	[[civilian,west,independent], "Prominent", {false}, "Obtained over 1,000,000 prestige.", "Title: Prominent, Money Cap: $2,000,000, Jury Corruption", "The Prominent %1"],
	[[civilian,west,independent], "Tycoon", {false}, "Obtained over 5,000,000 prestige.", "Title: Tycoon, Money Cap: $6,000,000, Global Discounts", "Tycoon %1"],
	[[civilian,west,independent], "Eminent", {false}, "Obtained over 10,000,000 prestige.", "Title: Eminent, Money Cap: Unlimited, Purchasable Jet", "The Eminent %1"],
	...
	[[civilian,west,independent], "Wolf Pack", {false}, "Obtained over 8,000,000 prestige.", "Access to Wolf Dew Sport Hatchback", ""],
	[[civilian], "Oppressor", {(life_statistics select 5) >= 200}, "Achieved 200 gang war rating across all seasons.", "Title: Oppressor", "Oppressor %1"],
	[[civilian], "The Punisher", {(life_statistics select 5) >= 750}, "Achieved 750 gang war rating across all seasons.", "Title: The Punisher", "%1 the Punisher"],
	...
	[[civilian], "Elusive", {(life_statistics select 6) >= 5}, "Successfully evaded 5 APBs.", "Title: Elusive", "Elusive %1"],
	[[civilian], "The Invisible", {(life_statistics select 6) >= 10}, "Successfully evaded 10 APBs.", "Title: The Invisible", "%1 the Invisible"],
	[[civilian,west,independent], "Seasoned", {false}, "Played in first days of PvP seasons.", "US 6-Color Desert Camo", "", true],
	[[civilian,west,independent], "Gang Wars Champion", {false}, "Reigning Champion of the Asylum Gang Wars", "Title: Gang Wars VI Winner", "Big Dick %1", true],
	[[civilian,west,independent], "Old School", {false}, "Donated before debit card changes.", "None", ""]
];
life_masks = ["G_Balaclava_blk","G_Balaclava_combat","G_Balaclava_lowprofile","G_Balaclava_oli","G_Bandanna_aviator","G_Bandanna_beast","G_Bandanna_blk","G_Bandanna_khk","G_Bandanna_oli","G_Bandanna_shades","G_Bandanna_sport","G_Bandanna_tan","G_Balaclava_TI_G_blk_F","G_Balaclava_TI_blk_F","G_Balaclava_TI_G_tna_F","G_Balaclava_TI_tna_F"];
...
life_jailPoly = [[16809.6,13637.2,0],[16741.1,13572.5,0],[16690.9,13623.6,0],[16758.9,13690.5,0]];
...
life_adminReq = (profileNamespace getVariable["AsylumSettings",[1200,1200,1600,true,false,0.2]]) select 4;
life_volume = (profileNamespace getVariable["AsylumSettings",[1200,1200,1600,true,false,0.2]]) select 5;
my_markers = [];
life_offers = 0;
//life_mailbox = [];
life_priced = false;
//life_prestige_per_donor = 100000; // Each donor level grants this much more prestige for achievement access
life_disallowedThreatWeapons = ["", "Binocular","hgun_Pistol_Signal_F"]; // weapons that can't be used for threatning someone
...
life_bounty_tracked = [-500,-500,-500,-500];
life_dispatch = [0,"",0];
life_statistics = [0,0,0,0,0,0,0]; // war kills, war deaths, war points, police arrests, bounty hunter arrests, global war points, apb evades
life_kill_cache = [];
life_gathering = false;
life_virt_open = false;
life_achievements = [];
life_last_bounty = [0,0];
life_istagged = false;
...
life_dispatchTasks = [];
life_last_airhq = -600;
life_last_broadcast = 0;
life_last_vdm = 0;
life_last_sold = 0;
life_last_restrained = 0;
life_jail_time = 0;
life_lastUpdatePacket = [];
life_bounty_uid = [];
life_arrested_uid = [];
life_disable_actions = false;
life_revive_fee = 3500; // Fee to pay for revive
life_last_shank = -200;
...
for "_i" from 1 to 116 do {life_spawn_markers set [count life_spawn_markers, format["veh_sp_%1",_i]];};
life_hwSpeed = 90;
life_citySpeed = 60;
//fireMode = "Single"; - Not Used anymore
...
} else { {life_public_houses pushBackUnique _x} forEach ["1466373","1247468","1247469","1332380"]; };
...
if (isNil "life_bank_gates") then { life_bank_gates = []};
...
switch (playerSide) do
{
	case west:
	{
		["atm","set",1000] call life_fnc_updateMoney;
...
[
	...
	["cncBarrier","Land_CncBarrierMedium_F","Concrete Barrier",0,4, true],
	["cncBarrierL","Land_CncBarrierMedium4_F","Concrete Barrier Long",0,4, true],
	["barGate","Land_BarGate_F","Bar Gate", 0, 4, false],
	["ladder","Land_Obstacle_Climb_F","Ladder Bridge", 90, 5, false],
...
life_vehicleInfo = switch (worldName) do {
	case "Altis": {
		[
			...
			["med_car","C_Van_02_medevac_F",2500,0,0,0,0,108,independent,0,0,false],
			["med_car","C_Hatchback_01_sport_F",5000,0,0,0,0,108,independent,0,0,false],
			...
			["reb_car","O_T_LSV_02_unarmed_F",50000,50,0,0,0,0,civilian,0,0,false],
			["reb_car","B_T_LSV_01_unarmed_F",45000,50,0,0,0,0,civilian,0,0,false],
			["reb_car","O_MRAP_02_F",97500,120,0,0,0,106,civilian,0,0,false],
			["reb_car","O_LSV_02_armed_F",150000,50,0,0,0,106,civilian,0,0,false],
			["reb_car","I_C_Offroad_02_LMG_F",50000,0,0,0,0,106,civilian,0,0,false],
			...
			["reb_car","I_Heli_light_03_unarmed_F",83000,100,0,0,0,21,civilian,0,0,false],
			["reb_car","O_Heli_Light_02_unarmed_F",90000,100,0,0,0,21,civilian,0,0,false],
			["reb_car","O_Heli_Transport_04_F",150000,100,0,0,0,21,civilian,0,0,false],
			["reb_car","O_Heli_Transport_04_bench_F",120000,100,0,0,0,21,civilian,0,0,false],

			["bh_car","C_SUV_01_F",4000,125,0,0,0,17,civilian,0,0,false],
			["bh_car","B_G_Offroad_01_F",3000,150,0,0,0,0,civilian,0,0,false],
			["bh_car","C_Van_01_transport_F",6000,250,0,0,0,17,civilian,0,0,false],
			["bh_car","C_Hatchback_01_sport_F",5000,100,0,0,0,17,civilian,0,0,false],
			["bh_car","C_Offroad_02_unarmed_F",3500,150,0,0,0,0,civilian,0,0,false],
			["bh_car","O_T_LSV_02_unarmed_F",50000,50,0,0,0,0,civilian,0,0,false],
			["bh_car","B_T_LSV_01_unarmed_F",45000,50,0,0,0,0,civilian,0,0,false],
			["bh_car","B_MRAP_01_F",97500,120,0,0,0,0,civilian,0,0,false],
			["bh_car","B_Heli_Light_01_F",70000,80,0,0,0,20,civilian,0,0,false],
			["bh_car","I_Heli_light_03_unarmed_F",83000,100,0,0,0,21,civilian,0,0,false],
			["bh_car","O_Heli_Light_02_unarmed_F",90000,100,0,0,0,21,civilian,0,0,false],
			...
			["cop_car","C_Hatchback_01_sport_F",5000,100,0,2,0,96,west,0,0,false],
			["cop_car","C_Van_02_transport_F",12000,400,0,3,0,96,west,0,0,false],
			["cop_car","B_T_LSV_01_unarmed_F",20000,50,0,3,0,100,west,0,0,false],
			...
			["cop_car","C_Offroad_01_F",3000,150,0,3,0,0,west,39,0,false],
			...
			["cop_car","C_Van_01_fuel_F",9600,350,0,0,0,0,west,41,0,false],
			["cop_car","C_Truck_02_fuel_F",30000,700,0,0,0,0,west,41,0,false],
			["cop_car","B_Truck_01_fuel_F",54000,1000,0,0,0,0,west,41,0,false],
			["cop_car","C_Van_02_vehicle_F",12000,400,0,3,0,96,west,40,0,false],
			["cop_car","C_Van_02_transport_F",12000,400,0,3,0,96,west,40,0,false],
			["cop_car","B_T_LSV_01_unarmed_F",25000,50,0,3,0,100,west,41,0,false],
			["cop_car","B_MRAP_01_F",40000,120,0,4,0,100,west,41,0,false],

			["civ_truck","C_Van_01_box_F",8000,350,0,0,0,17,civilian,0,0,false],
			["civ_truck","C_Van_01_fuel_F",9600,350,0,0,0,17,civilian,0,0,false],
			...
			["civ_truck","C_Truck_02_fuel_F",30000,700,0,0,0,19,civilian,0,0,false],
			...
			["civ_truck","B_Truck_01_fuel_F",54000,1000,0,0,0,19,civilian,0,0,false],
			["civ_truck","C_Van_02_vehicle_F",12000,400,0,0,0,17,civilian,0,0,false],
			["civ_truck","C_Van_02_transport_F",12000,400,0,0,0,17,civilian,0,0,false],

			["civ_special","C_Van_01_box_F",18000,350,0,0,0,17,civilian,0,0,false], //402 weight set elsewhere
			...
			["civ_air","O_Heli_Light_02_unarmed_F",90000,100,0,0,0,21,civilian,0,0,false],
			["civ_air","I_Heli_Transport_02_F",100000,300,0,0,0,21,civilian,0,0,false],
			["civ_air","I_Plane_Fighter_03_CAS_F",60000,100,0,0,0,0,civilian,0,0,false],
			...
			["cop_air","B_Heli_Light_01_F",35000,80,0,2,0,97,west,0,0,false],
			["cop_air","I_Heli_light_03_unarmed_F",60000,100,0,3,0,99,west,0,0,false],
			["cop_air","B_Heli_Transport_03_unarmed_F",90000,80,0,5,0,98,west,0,0,false],
			["cop_air","O_Heli_Light_02_unarmed_F",90000,70,0,4,0,98,west,0,0,false],
...
//			["cop_air","I_Heli_light_03_unarmed_F",70000,80,0,3,0,0,west,43,0,false],
			...
			["cop_air","I_Heli_Transport_02_F",100000,300,0,3,0,0,west,44,0,false],
			...
			["civ_ship","C_Boat_Civil_01_rescue_F",3000,200,0,0,0,0,civilian,0,0,false],
	...
	case "Tanoa": {
		[
			...
			["reb_car","B_Quadbike_01_F",250,50,0,0,0,0,civilian,0,0,false],
			["reb_car","B_G_Offroad_01_F",3000,150,0,0,0,0,civilian,0,0,false],
			["reb_car","O_T_LSV_02_unarmed_F",5000,50,0,0,0,0,civilian,0,0,false],
			["reb_car","B_T_LSV_01_unarmed_F",6000,50,0,0,0,0,civilian,0,0,false],
			["reb_car","B_G_Offroad_01_armed_F",150000,0,0,0,0,106,civilian,0,0,false],
			["reb_car","B_Heli_Light_01_F",70000,80,0,0,0,20,civilian,0,0,false],
			...
			["bh_car","C_Hatchback_01_sport_F",5000,100,0,0,0,17,civilian,0,0,false],
			["bh_car","C_Offroad_02_unarmed_F",3500,150,0,0,0,0,civilian,0,0,false],
			["bh_car","O_T_LSV_02_unarmed_F",5000,150,0,0,0,0,civilian,0,0,false],
			["bh_car","B_T_LSV_01_unarmed_F",6000,50,0,0,0,0,civilian,0,0,false],
			["bh_car","B_Heli_Light_01_F",70000,80,0,0,0,20,civilian,0,0,false],
			["bh_car","I_Heli_light_03_unarmed_F",120000,100,0,0,0,21,civilian,0,0,false],
			["bh_car","O_Heli_Light_02_unarmed_F",130000,100,0,0,0,21,civilian,0,0,false],

			["cop_car","I_Quadbike_01_F",150,50,0,1,0,0,west,0,0,false],
			["cop_car","C_Offroad_01_F",500,150,0,2,0,95,west,0,0,false],
			["cop_car","C_Offroad_02_unarmed_F",8000,150,0,2,0,95,west,0,0,false],
			["cop_car","C_SUV_01_F",3500,125,0,2,0,96,west,0,0,false],
			["cop_car","C_Hatchback_01_sport_F",10000,100,0,2,0,96,west,0,0,false],
			["cop_car","C_Hatchback_01_F",5000,150,0,3,0,0,west,38,0,false],
			["cop_car","B_G_Offroad_01_F",3000,150,0,3,0,0,west,39,0,false],
			["cop_car","C_Offroad_02_unarmed_F",8000,150,0,2,0,95,west,39,0,false],
			["cop_car","C_SUV_01_F",4000,125,0,3,0,0,west,40,0,false],
...
[
	...
	["LMG_Mk200_F",50000],
	["srifle_DMR_01_F",5000],
	["srifle_EBR_F",9000],
	["srifle_DMR_03_khaki_F",11000],
	["srifle_DMR_03_multicam_F",11000],
	["srifle_DMR_03_tan_F",11000],
	["srifle_DMR_03_woodland_F",11000],
	["srifle_DMR_06_olive_F",7000],
	["srifle_DMR_06_camo_F",7000],
	["hgun_ACPC2_F",3000],
	["hgun_PDW2000_F",5000],
	["SMG_02_F",4500],
	["SMG_01_F",6000],
	...
	["arifle_AKM_F",7000],
	["arifle_AK12_F",10000],
	["arifle_SPAR_03_khk_F",8000],
	["arifle_SPAR_03_snd_F",8000],
	["LMG_03_F",38500]
];
...
[
	...
	["B_MRAP_01_F",2500],
	["I_MRAP_03_F",3000],
	["O_Heli_Transport_04_bench_F",3500],
	["O_Heli_Transport_04_F",3500]
];
life_skiptracerInfo =
[
	...
	[15, 25000, "Lockpick and a Dream", 14, "Increased chance of succeeding with vehicle lockpicking. 15% off claiming vehicles."],
...
[
	...
	[39, 15000, "Improved Vehicles", 38, "Access to unmarked offroads and jeeps."],
	[40, 30000, "Advanced Vehicles", 39, "Access to unmarked SUVs, sports hatchback, and Vans."],
	[41, 65000, "Vehicle Master", 40, "Access to civilian trucks and Prowlers for advanced sting operations."],
	[42, 10000, "Basic Air", 37, "Access to unmarked MH9/M900."],
	[43, 35000, "Improved Air", 42, "Access to unmarked Hellcat and Orca."],
	[44, 65000, "Advanced Air", 43, "Access to unmarked Mohawk."],
...
//	[6, "CIV", "Bounty Hunter 4", 4, "Unlimited maximum bounty. Can see tracking locations from group members."],
	...
	[126, "CIV", "Master Bounty Hunter", 9, "Access to civilian Hunter.  No charge applied when restraining group member's bounty. Unlimited maximum bounty. Access to Skiptracer and the Honor Talent system. (can not have Marksman)"],
	...
	[106, "CIV", "Ranking Rebel", 19, "Ability to buy and take out heavy para-military vehicles."],
	...
	[27, "CIV", "Meth Cook", 26, "Maximum return when cooking crank or methamphetamine."],
	...
	[127, "CIV", "Drug Hawker", 0, "Reduced chance of police being alerted to your Drug Runner activities."],
	[128, "CIV", "Drug Baron", 127, "Further reduced chance of police being alerted to your Drug Runner activities."],
	...
	[43, "CIV", "Heister", 42, "Faster with bolt-cutters on gates, can open gates fully, and adept at avoiding gate alarm triggers."],
	...
	// Police
	[68, "WEST", "Watch Dog", 0, "Chance to receive alerts when fugitives use an ATM."],
	[69, "WEST", "Informants", 68, "Chance that informants may spot fugitives in populated areas."],
	[70, "WEST", "Snitches", 69, "Chance to be notified when fugitives enter an illegal area."],
	[71, "WEST", "Surveillance", 70, "Able to purchase the AR-2 Darter drone. (Sergeant)"],
	[72, "WEST", "On the Beat", 70, "Chance to be alerted of drug dealer and drug runner transactions."],
	...
	[96, "WEST", "Patrol Officer", 95, "Able to purchase the police SUV and hatchback sport (Constable) and Paddy Wagon. (Corporal)"],
	[97, "WEST", "Flight Training", 96, "Able to purchase the MH-9 Hummingbird. (Constable)"],
	[98, "WEST", "Flight Transport", 99, "Able to purchase Orca / Huron (Sergeant/Lieutenant)"],
	[99, "WEST", "Advanced Pilot", 97, "Able to purchase the WY-55 Hellcat. (Corporal)"],
	[100, "WEST", "Advanced Driver", 96, "Able to purchase the Prowler (Corporal) and Hunter (Sergeant)"],
	[101, "WEST", "Profiteer", 0, "Receive 75% of arrested criminal's warrant value and a 10% bonus on drugs seized from vehicles."],
	[102, "WEST", "Profiteer 2", 101, "Receive 85% of arrested criminal's warrant value and a 20% bonus on drugs seized from vehicles."],
	[103, "WEST", "Profiteer 3", 102, "Receive 100% of arrested criminal's warrant value and a 30% bonus on drugs seized from vehicles."],
...
life_lastDisplay = -2;//Variable for custom dialog system
life_scriptCooldowns = [];//Variable for my scriptCooldown define which allows easy prevention of spamming scripts.

//Infamy data and variables
life_infamyContractDialogInfo = [displayNull, controlNull];//Array for storing UI information for the infamy contract menu
life_infamyAllContractData = [];//The array that stores all the contracts we receive from the server
life_infamyFetchingContracts = false;//Are we actively fetching data from the server? If yes do or dont do certain things
life_infamyContractMenuStopFocus = false;//Do we want to pause the auto-focus adjust loop thats in fn_infamyInitContractMenu.sqf? We do this if a popup is opened
life_infamy_cache = "";//cache var for syncing checks
life_infamyLevel = 0;//Total infamy currency player has
life_infamyTalents = [];//The infamy talents a player has
life_infamyScalps = [];//Array for storing skal items of targets you kill.
life_infamyCartelCooldown = 0;

life_infamyContractID = -1;
life_infamyContractTargetID = "";//I stored these seperate instead of an array for ease of access/usability.
life_infamyContractTargetName = "";
life_infamyContractTargetBounty = 0;//this value is only a temporary one for display, when you go to sell the scalp you get the most updated value.

life_infamyInfo = [//Talent ID, talent price, talent name, pre-requisite talent ID, description
	[1, 500, "Assassin", [0,0], "The assassin will use his skills to track down and kill those who have angered their fellow citizens."],
	[2, 2000, "Assassin's Apprentice", [1,1], "250 metre radius on target location areas."],
	[3, 10000, "Oh There You Are", [2,2], "210 metre radius on target location areas."],
	[4, 25000, "I See You", [3,3], "175 metre radius on target location areas."],
	[5, 2000, "Almost There", [1,1], "2.5 minute target updates."],
	[6, 10000, "On My Way", [5,5], "2 minute target updates."],
	[7, 25000, "Watch Your Back", [6,6], "1.5 minute target updates."],
	[8, 2000, "Dolla Bills Y’all", [1,1], "40% of the player bounty amount is kept"],
	[9, 10000, "Gonna Get Paid", [8,8], "55% of the player bounty amount is kept"],
	[10, 25000, "Bitch Better Have My Money", [9,9], "70% of the player bounty amount is kept"],
	[11, 50000, "Master Assassin", [1,10], "Automatically set in game waypoint to the center of the circle for the most recently tracked target."],

	[12, 500, "Intimidator", [0,0], "The intimidator uses his infamy to influence those around him."],
	[13, 2000, "Friend of Yours", [12,12], "5% discount on rebel items and vehicles."],
	[14, 10000, "Friend of Mine", [13,13], "10% discount on rebel items and vehicles."],
	[15, 25000, "Friend of Ours", [14,14], "15% discount on rebel items and vehicles."],
	[16, 2000, "Shakedown", [12,12], "7% increase in sale price of illegal items."],
	[17, 10000, "Coercion", [16,16], "15% increase in sale price of illegal items."],
	[18, 25000, "F*#@ You - Pay Me", [17,17], "25% increase in sale price of illegal items."],
	[19, 2000, "Black Tar Pusher", [12,12], "10% faster collection of unprocessed heroin."],
	[20, 10000, "Cokehead", [19,19], "10% faster collection of unprocessed cocaine."],
	[21, 25000, "Speed Freak", [20,20], "10% faster collection of unprocessed ephedra."],
	[22, 50000, "Master Intimidator", [12,21], "20% decrease in overall bounty - even the APD pays their respect to you."],

    [23, 500, "Outlaw", [0,0], "Outlaws use their skills to reek havoc on the people and the APD."],
    [24, 2000, "Nimble fingers", [23,23], "10% faster lockpicking"],
    [25, 10000, "I got this", [24,24], "20% faster lockpicking"],
    [26, 25000, "Hand me the keys YFCS", [25,25], "30% faster lockpicking, 15% off claiming vehicles."],
    [27, 2000, "Give it up sucker", [23,23], "10% more money received from gas station robberies"],
    [28, 10000, "I said gimme the cash", [27,27], "30% more money received from gas station robberies"],
    [29, 25000, "I will shoot you", [28,28], "50% more money received from gas station robberies"],
    [30, 2000, "Ima stick this in you", [23,23], "Bloodbag 25% faster"],
    [31, 10000, "kek you got hit by a car", [30,30], "Splint 25% faster"],
    [32, 25000, "Coulda teambagged him instead", [31,31], "Defib 25% faster"],
    [33, 50000, "Master Outlaw", [23,32], "Access to a full medical shop at the rebel outpost."]
];
//8.0
