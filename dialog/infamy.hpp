class life_infamy_menu {
	idd = 643700;
	name= "life_infamy_menu";
	movingEnable = false;
	enableSimulation = true;
	onLoad = "[] spawn life_fnc_infamyOpenMenu;";
	...
	class controls {
		...
		class TalentList : Life_RscListBox 
		{
			...
			sizeEx = 0.035;
			//colorBackground[] = {0,0,0,0};
			onLBSelChanged = "[_this] call life_fnc_infamyMenuGetDetails";
		...
		class LearnButtonKey : Life_RscButtonMenu {
			idc = 643710;
			text = "Learn";
			onButtonClick = "[] call life_fnc_infamyLearn;";
