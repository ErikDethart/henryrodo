...
class lootcrate_menu {
	...
	class controls {
		...
		{
			idc = -1;
			text = "Loot crates are semi-rare items you can find which require a matching key to be opened. Inside, you'll find all sorts  of rewards, from common to very rare.";
		...
		{
			idc = -1;
			text = "You can add keys to open loot crates on your My Asylum webpage at my.gaming-asylum.com.";
			x = 7 * GUI_GRID_W + GUI_GRID_X;
		...
		{
			idc = 22201;
			text = "POSSIBLE CONTENTS OF LOOT CRATE";
			x = 6 * GUI_GRID_W + GUI_GRID_X;
		...
		{
			idc = 22212;
			text = "<a href='http://my.gaming-asylum.com'>BUY CRATE KEY</a>";
		...
		{
			idc = 22214;
			text = "Open This Crate";
			onButtonClick = "[life_crate] spawn life_fnc_openLootCrate;";
			x = 6 * GUI_GRID_W + GUI_GRID_X;
			y = 21.5 * GUI_GRID_H + GUI_GRID_Y;
			w = 9 * GUI_GRID_W;
			h = 1 * GUI_GRID_H;
