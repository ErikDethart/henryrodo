class life_broadcast_menu {
	...
	class controls {
		...
		{
			idc = -1;
			text = "Broadcast ($30,000)";
			x = 0.5 * safezoneW + safezoneX;
			y = 0.547007 * safezoneH + safezoneY;
			w = 0.10572 * safezoneW;
			h = 0.0188029 * safezoneH;
			onButtonClick = "['atm','take',30000] call life_fnc_updateMoney; [ctrlText 10402,ctrlText 10404,profileName] remoteExec [""life_fnc_showBroadcast"",-2];; life_last_broadcast = time; publicVariable ""life_last_broadcast""; closeDialog 0;";
		};
