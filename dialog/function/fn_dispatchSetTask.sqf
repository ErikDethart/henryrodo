...
[[0,1,2],format["Dispatch has relieved you of %1.", _row select 1]] remoteExecCall ["life_fnc_broadcast",_cop];
		};
	};
};
...
[_task select 0,_task select 1,_task select 2] remoteExecCall ["life_fnc_newDispatch", _cop];
