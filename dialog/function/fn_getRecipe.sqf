...
if (isClass (configFile >> "CfgVehicles" >> _class)) then {
	...
	_qty = _class call life_fnc_getQuantity;
	_sellPrice = [_vehicleInfo,_price,_qty,false] call life_fnc_calcPrice;
	_desc = format["<t size='1'>Base Price: <t color='#8cff9b'>$%7</t>  Sell Price: <t color='#8cff9b'>$%8</t><br/>Max Speed: %1 km/h<br/>Horse Power: %2<br/>Passenger Seats: %3<br/>Trunk Capacity: %4<br/>Fuel Capacity: %5<br/>Armor Rating: %6",
