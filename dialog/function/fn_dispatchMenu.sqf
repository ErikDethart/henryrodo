...
if ((call life_coplevel) < 2) exitWith { hint "You are not of sufficient rank within the police force to operate as a dispatcher." };

life_dispatcher = nil;
hint "Requesting permission to act as dispatcher...";
[player] remoteExecCall ["ASY_fnc_requestDispatcher",2];
...
[_unit, _pos, _alt] remoteExecCall ["ASY_fnc_setWaypoint",2];
...
[player, -1, true] remoteExecCall ["ASY_fnc_manageRadio",2];
};
