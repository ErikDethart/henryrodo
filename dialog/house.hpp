class HouseMenu
{
	...
	class controlsBackground
	{
		...
		class RscHouseCrateCount : Life_RscText
		{
			idc = 12509;
			colorBackground[] = {0, 0, 0, 0};
			text = "Counting crates...";
			sizeEx = 0.04;
	...
	class Controls
	{
		class BuyHouse : Life_RscButtonMenu
		{
			...
			y = (0.472556 + 0.022) * safezoneH + safezoneY;
		...
		class MoveGang : Life_RscButtonMenu
		{
			idc = 12520;
			text = "Move Gang";
			colorBackground[] = {0.5, 0, 0, 0.5};
			onButtonClick = "closeDialog 0; [_house] call life_fnc_gangHouseSelect;";
			x = 0.424297 * safezoneW + safezoneX;
			y = (0.472556 + 0.022) * safezoneH + safezoneY;
			w = 0.061875 * safezoneW;
			h = 0.022 * safezoneH;
		...
		class Close : Life_RscButtonMenu
		{
			...
			y = (0.472555 + 0.022) * safezoneH + safezoneY;
			w = 0.061875 * safezoneW;
			h = 0.022 * safezoneH;
		};
	};
