class Life_Client_Core
{
	...
	class Infamy
	{
		...
		//General contract handling functions.
		class infamyContractKilled {};
		class infamyContractSell {};
		class infamyContractPlace {};
		class infamyContractTake {};
		class infamyPickupScalp {};
		class infamyTrackTarget {};
		class infamyReward {};
		class addInfamy {};


		//Files for the custom menu for picking/placing contract.
		class infamyInitContractMenu {};
		class infamyContractMenuChoose {};
		class infamyContractMenuPlace {};

		//Files for the phone app talent view
		class infamyLearn {};
		class infamyMenuAddRow {};
		class infamyMenuGetDetails {};
		class infamyOpenMenu {};
		class infamyRespec {};

		//function for handling variable modifications for certain talents, much nicer than the other method used for other trees
		class infamyModifiers {};
	};
	...
	class Functions
	{
		...
		class setIllegalNPCLocation {};
		class setIdleTime {};
		class cartelCapture {};
		class setupCaptureTriggers {};
		class monitorScriptHandle {};
		class networkSetVar {};
	};
	...
	class Dialog_Controls
	{
		...
		class dispatchRadio {};
		class gangHouseSelect {};
		class gangMoveConfirm {};
		class gangHousePointSelected {};

		//Custom dialog handling functions
		class createDialogCustom {};
		class animateDialog {};
		class ctrlCreate {};
		class dialogLoading {};
	};
