...
[profileName,getPlayerUID player,(configName _patchEntry)] remoteExecCall ["SPY_fnc_cookieJar",2];
[profileName,format["Unknown Addon Patch: %1",(configName _patchEntry)]] remoteExecCall ["SPY_fnc_notifyAdmins",-2];
				uiSleep 0.5;
...
[profileName,getPlayerUID player,"Modified_MPInterrupt"] remoteExecCall ["SPY_fnc_cookieJar",2];
[profileName,"Devcon like executor detected"] remoteExecCall ["SPY_fnc_notifyAdmins",-2];
		uiSleep 0.5;
		["SpyGlass",false,false] call BIS_fnc_endMission;
	};
} foreach _children;
...
[profileName,getPlayerUID player,"Modified_RscDisplayInventory_onLoad"] remoteExecCall ["SPY_fnc_cookieJar",2];
[profileName,"Modified RscDisplayInventory_onLoad (CheatEngine injection)"] remoteExecCall ["SPY_fnc_notifyAdmins",-2];
	uiSleep 0.5;
	["SpyGlass",false,false] call BIS_fnc_endMission;
};
...
[profileName,getPlayerUID player,"Modified_RscDisplayInventory_onUnload"] remoteExecCall ["SPY_fnc_cookieJar",2];
[profileName,"Modified RscDisplayInventory_onUnload (CheatEngine injection)"] remoteExecCall ["SPY_fnc_notifyAdmins",-2];
	uiSleep 0.5;
	["SpyGlass",false,false] call BIS_fnc_endMission;
};
